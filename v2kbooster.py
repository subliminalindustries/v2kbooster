...
parser.add_argument('--fftn', required=False, type=int, help='Number of FFT bins (ex.: 8192)', default=8192)
parser.add_argument('--weights', required=False, type=str, nargs='+', help='List of harmonic weights (ex.: 1. .5 .33 .25 .165)', default=[1., .5, .33, .25, .165])
