...
parser.add_argument('-w', '--weights', required=False, type=str, nargs='+',
                    help='List of harmonic weights (default: 1. .5 .33 .25 .165)', default=[1., .5, .33, .25, .165])
parser.add_argument('pattern', type=str, help='File glob pattern (ex.: "./*.wav")')

args = parser.parse_args(sys.argv[1:])

v2kbooster.process(args.pattern, nfft=args.fftn, weights=args.weights, overwrite=args.overwrite)
